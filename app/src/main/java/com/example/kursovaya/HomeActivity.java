        ...
        for(int i = 0; i < 7; i++) {
            ...
            if (i < dayOfWeek) {
                ...
                tempButton.setOnClickListener(view -> {
                    ...
                    Intent intent = new Intent(HomeActivity.this, EditNotes.class);
                    intent.putExtra("user", getIntent().getStringExtra("user"));
                    Toast.makeText(HomeActivity.this, "Passed date:  " + new SimpleDateFormat("dd/MM/yyyy").format(calendar.getTime()) + "!", Toast.LENGTH_SHORT).show();
